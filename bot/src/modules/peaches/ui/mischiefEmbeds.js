...
export async function buildShredPayload(name, mischiefId) {
  const row = new ActionRowBuilder().addComponents(
...
export async function buildWallsPayload(name, mischiefId) {
  const row = new ActionRowBuilder().addComponents(
...
export async function buildRulerPayload(name, mischiefId) {
  const row = new ActionRowBuilder().addComponents(
